...
import type { VerifyEmailCommand, VerifyEmailResult } from '@application/auth/dto/verify-email-auth.dto.js';
...
export class VerifyEmailUseCase {
  constructor(
    ...
    private readonly activeStatusId: number,
  ) {}
  ...
  async execute(command: VerifyEmailCommand): Promise<VerifyEmailResult> {
    ...
    const activated = user.activate(this.activeStatusId);
